				...
				<div class="card-body">
					...
					<form method="POST" action="ProductController">
							...
							<div class="col-2">
								<div class="input-group">
									<label class="label">Product Name</label> <input
										class="input--style-4" type="text" name="pname">
						...
						<div class="row row-space">
							<div class="col-2">
								<div class="input-group">
									<label class="label">Cost</label> <input
										class="input--style-4" type="text" name="cost">
								</div>
							</div>
							<div class="col-2">
								<div class="input-group">
									<label class="label">Quantity</label> <input
										class="input--style-4" type="text" name="quantity">
								</div>
							</div>
						</div>

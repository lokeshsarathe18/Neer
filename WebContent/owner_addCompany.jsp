					...
					<form method="POST" action="CompanyController">
						...
						<div class="row row-space">
							...
							<div class="col-2">
								...
								<input
										class="input--style-4" type="hidden" name="owner_id" value="<%=session.getAttribute("user_id")%>">
									</div>
							</div>
						</div>
						...
						<div class="row row-space">
							<div class="col-2">
								<div class="input-group">
									<label class="label">Covering Area</label> <input
										class="input--style-4" type="text" name="covering_area">
								</div>
							</div>
							<div class="col-2">
								<div class="input-group">
									<label class="label">Mobile Number</label> <input
										class="input--style-4" type="text" name="mobile_no">
								</div>
							</div>
						</div>
						...
						<div class="p-t-15">
							<button class="btn btn--radius-2 btn--blue" type="submit" value="add_company" name="option" >Submit</button>
						</div>
				</div>
			</div>
